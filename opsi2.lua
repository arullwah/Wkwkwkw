...
local function UpdatePlayButtonStatus()
    ...
    SafeCall(function()
        -- [KONDISI 1] SEDANG MAIN --> TAMPILKAN TOMBOL PAUSE (MERAH)
        ...
        -- [KONDISI 2] SEDANG DIAM --> TAMPILKAN TOMBOL RESUME/PLAY (HIJAU)
        -- Cek apakah ada rekaman di dekat pemain
        local nearestRecording, distance = FindNearestRecording(50)
        
        if nearestRecording and distance <= 50 then
            -- Jika dekat checkpoint/rekaman
            ...
            -- Jika jauh atau tidak ada rekaman
...
NextBtn.InputEnded:Connect(function(input)
    ...
    LoopBtnControl.MouseButton1Click:Connect(function()
        PlaySound("Click") -- Hapus AnimateButtonClick
        AutoLoop = not AutoLoop
        if AutoLoop then
            LoopBtnControl.Text = "Loop ON"
            LoopBtnControl.BackgroundColor3 = Color3.new(0, 0, 0) -- Hitam
            ...
            LoopBtnControl.Text = "Loop OFF"
            LoopBtnControl.BackgroundColor3 = Color3.fromRGB(80, 80, 80) -- Abu-abu
            StopAutoLoopAll()
        end
    end)
    ...
    JumpBtnControl.MouseButton1Click:Connect(function()
        ...
        if InfiniteJump then
             JumpBtnControl.Text = "Jump ON"
             JumpBtnControl.BackgroundColor3 = Color3.new(0, 0, 0) -- Hitam
        else
             JumpBtnControl.Text = "Jump OFF"
             JumpBtnControl.BackgroundColor3 = Color3.fromRGB(80, 80, 80) -- Abu-abu
        end
    end)
    ...
    RespawnBtnControl.MouseButton1Click:Connect(function()
        ...
        if AutoRespawn then
            ...
            RespawnBtnControl.BackgroundColor3 = Color3.new(0, 0, 0) -- Hitam
        else
            RespawnBtnControl.Text = "Respawn OFF"
            RespawnBtnControl.BackgroundColor3 = Color3.fromRGB(80, 80, 80) -- Abu-abu
        end
        PlaySound("Toggle")
    end)
    ...
    ShiftLockBtnControl.MouseButton1Click:Connect(function()
        ...
        if ShiftLockEnabled then
            ShiftLockBtnControl.Text = "Shift ON"
            ShiftLockBtnControl.BackgroundColor3 = Color3.new(0, 0, 0) -- Hitam
        else
            ShiftLockBtnControl.Text = "Shift OFF"
            ShiftLockBtnControl.BackgroundColor3 = Color3.fromRGB(80, 80, 80) -- Abu-abu
        end
    end)
    ...
    ResetBtnControl.MouseButton1Click:Connect(function()
        ...
        if AutoReset then
            ...
            ResetBtnControl.BackgroundColor3 = Color3.new(0, 0, 0) -- Hitam
        else
            ResetBtnControl.Text = "Reset OFF"
            ResetBtnControl.BackgroundColor3 = Color3.fromRGB(80, 80, 80) -- Abu-abu
        end
        PlaySound("Toggle")
    end)
    ...
    ShowRuteBtnControl.MouseButton1Click:Connect(function()
        ...
        if ShowPaths then
            ...
            ShowRuteBtnControl.BackgroundColor3 = Color3.new(0, 0, 0) -- Hitam
            PathsHiddenOnce = false
            PathHasBeenUsed = {}
            VisualizeAllPaths()
        else
            ShowRuteBtnControl.Text = "Path OFF"
            ShowRuteBtnControl.BackgroundColor3 = Color3.fromRGB(80, 80, 80) -- Abu-abu
            ClearPathVisualization()
        end
    end)
