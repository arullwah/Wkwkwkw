...
function UpdateRecordList()
    ...
    for index, name in ipairs(RecordingOrder) do
        ...
        playBtn.Position = UDim2.fromOffset(22, 3)
        ...
        delBtn.Position = UDim2.fromOffset(51, 3)
        ...
        nameBox.Position = UDim2.fromOffset(80, 3)
        ...
        upBtn.Position = UDim2.new(1, -55, 0, 3)
        ...
        downBtn.Position = UDim2.new(1, -27, 0, 3)
