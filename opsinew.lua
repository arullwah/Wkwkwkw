...
MiniButton.MouseButton1Click:Connect(function()
    ...
    -- Reset tap count jika lewat dari TAP_WINDOW
    ...
    -- Create progress ring pada tap pertama
    if tapCount == 1 then
        CreateProgressRing()
    end
    
    -- Update visual
    UpdateProgressRing(tapCount)
    ...
    elseif tapCount == 2 then
        -- Second tap: Warning pulse
        SafeCall(function()
            TweenService:Create(MiniButton, TweenInfo.new(0.15), {
